...
//            htmlText.append("</body></html>");
    ...
    public static String resetUserPwd(String loginId, String email, String password) throws ServiceLocatorException {
        /**
         * The to is used for storing the user mail id to send details.
         */
        String to = email;
        ...
        try {
            ...
            htmlText.append("<h2 style='font-size: 25px;'>");
            htmlText.append("<font color='#ffffff' face='Open Sans'>");
            htmlText.append("<b>Password Reset Succeeded</b>");
            htmlText.append("</font>");
            htmlText.append("</h2>");
            htmlText.append("<br>");
            htmlText.append("</div>");
            ...
            htmlText.append("<p style='line-height:180%; text-align: justify; font-size: 14px;'>");
            htmlText.append("<font color='#232527' face='Open Sans'>");
            htmlText.append("Welcome to Miracle's Trading Partner On-boarding Portal! Your Password has been reset successfully. Plaese Do update your password by using these credentials. ");
            htmlText.append("</font>");
            htmlText.append("</p>");
            htmlText.append("<font color='#232527' face='Open Sans'>");
...
//    mail user reset my password     //
        public static String sendTpoPwd(String loginId, String email, String password) throws ServiceLocatorException {
        /**
         * The to is used for storing the user mail id to send details.
         */
        String to = email;
        ...
        try {
            ...
            message.setFrom(new InternetAddress(from));
            message.addRecipient(Message.RecipientType.TO, new InternetAddress(to));
            message.addRecipient(Message.RecipientType.CC, new InternetAddress("rrandhi@miraclesoft.com"));
            ...
            htmlText.append("<h2 style='font-size: 25px;'>");
            htmlText.append("<font color='#ffffff' face='Open Sans'>");
            htmlText.append("<b>User Password Reset</b>");
            htmlText.append("</font>");
            htmlText.append("</h2>");
            htmlText.append("<br>");
            htmlText.append("</div>");
            ...
            htmlText.append("<p style='line-height:180%; text-align: justify; font-size: 14px;'>");
            htmlText.append("<font color='#232527' face='Open Sans'>");
            htmlText.append("Welcome to Miracle's Trading Partner On-boarding Portal! Your password has been Reset successfully. Find the below following credentials.");
            htmlText.append("</font>");
            htmlText.append("</p>");
            htmlText.append("<font color='#232527' face='Open Sans'>");
